...
<div class="container-fluid body-section ">
   ...
   <?php require_once('inc/sidebar.php');?>     
        ...
        <div class="col-md-9">
            ...
            <ol  class="breadcrumb">
            <li><a href="#"><i class="fa fa-tachometer"></i> Dashboard</a></li> <li class="active"><i class="fa fa-user-plus"></i> Add New Users</li>  
            </ol>
            <?php
            if(isset($_POST['submit'])){
                $date = time();
                $first_name = mysqli_real_escape_string($con,strtolower($_POST['first-name']));
                ...
                if(empty($first_name) or empty($last_name) or empty($username) or empty($email) or empty($password) or empty($image)){
                    ...
                    $error = "Username or Emil Already Exist";
