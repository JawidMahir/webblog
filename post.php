             ...
             <?php }
                if(isset($_POST['submit'])){
                    ...
                    if(empty($cs_name) or empty($cs_email)or empty($cs_comment)){
                        $error_msg = "ALL (*) felids are Required";
                        
                    }
                    else {
                        $cs_query = "INSERT INTO `comments` (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES (NULL, '$cs_date', '$cs_name ', 'user', '$post_id', '$cs_email', '$cs_website', 'profile.jpg', '$cs_comment', 'pending ')";
           ...
           <div class="col-xs-12">
               <form action="" method="post">
                   <div class="form-group">
                     ...
                     <div class="form-group">
                       <lable for="f=email">Email Adress:*</lable>
