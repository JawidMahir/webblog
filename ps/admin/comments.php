...
<div class="container-fluid body-section ">
   ...
   <?php require_once('inc/sidebar.php'); ?>     
        ...
        <div class="col-md-9">
            ...
            <ol  class="breadcrumb">
            <li><a href="#"><i class="fa fa-tachometer"></i> Dashboard</a></li> <li class="active"><i class="fa fa-users"></i> Comments</li>  
            </ol>
            ...
            if(isset($_GET['reply'])){
                ...
                if(mysqli_query($con, $insert_comment_query)){
                    $commnet_msg = "Comment Has Been Submited";
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                   <form action="" method="post">
                    ...
                    else if(isset( $commnet_msg)){
                               echo "<span class='pull-right' style='color:green;'>$commnet_msg</span>";
                           }
                           ?>
                    ...
                    <tr>
                       <td><input type="checkbox" class="checkboxes" name="checkboxes[]" value="<?php echo $id;?>"></td>
                        ...
                        <td><span style="color:<?php 
                         ...
                         <td><a href="comments.php?approve=<?php echo $id;?>"><i class="fa"></i>Approve</a></td>
                        <td><a href="comments.php?unapprove=<?php echo $id;?>"><i class="fa "></i>Unapprove</a></td>
