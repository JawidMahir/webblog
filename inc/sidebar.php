    ...
    <div class="input-group">
      <input type="text" name="search-title" class="form-control" placeholder="Search for..." aria-label="Search for...">
...
<div class="widgets">
<div class="popular">
             <h4><strong>Social Icons</strong>s</h4>
            <hr>
             <div class="row">
                 <div class="col-xs-4">
